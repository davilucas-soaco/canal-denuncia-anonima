...
export function AttachmentSlots({
  ...
  function addSlot() {
    if (slotCount >= ATTACHMENT_LIMITS.maxFiles) return
    setSlotCount((c) => c + 1)
  }

  const canAdd = slotCount < ATTACHMENT_LIMITS.maxFiles
    ...
    <div className="space-y-3">
      <div>
        ...
        <p className="mt-0.5 text-xs text-brand-gray">
          PDF, imagens ou Word. Até {ATTACHMENT_LIMITS.maxFiles} arquivos, 10 MB cada.
        </p>
      </div>
